  ...
  <div class="flex mx-auto max-w-6xl justify-between my-8">
    <div class="w-5/7 mr-16 flex flex-wrap content-start">
      <div class="w-full border-b border-gray-200 pb-8">
        ...
        <div>
          <span>
            <span class="text-xs text-gray-500 font-medium">{{ cont.date }}</span>
            <span class="text-xs text-gray-500 font-medium">{{ cont.views }}</span>
            <span class="text-xs text-gray-500 font-medium">{{ cont.likes }}</span>
          </span>
          <span>
            <span></span>
            <span></span>
      ...
      <div class="w-full border-t border-b border-gray-200">
        <p class="pt-4 pl-2 pr-2 text-base font-bold tracking-tight">댓글 <span>14</span></p>
        <div class="write_area  pb-4">
          <form>
            ...
            <div class="flex items-center py-2 rounded-lg">
                ...
                <textarea ref="comment" id="chat" rows="1" @keyup="focusText" class="block p-2.5 mx-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="댓글을 남겨주세요..."></textarea>
                <span @click="commentbt" type="submit" :class="[emptyValue ? 'text-gray-400 hover:bg-gray-100' : 'text-blue-600 hover:bg-blue-100']" class="inline-flex justify-center p-2 rounded-full cursor-pointer dark:text-blue-500 dark:hover:bg-gray-600">
